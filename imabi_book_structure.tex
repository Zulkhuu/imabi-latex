...
{\addvspace{2pt}\small\sffamily\bfseries} % Spacing and font options for chapters
...
\draw[anchor=west] (\Gm@lmargin+.3cm,-9cm) node {\huge\sffamily\bfseries\color{black}第\thechapter 課\autodot~#1\strut};
\end{tikzpicture}};
\end{tikzpicture}
\else
\begin{tikzpicture}[remember picture,overlay]
